    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 text-xs mb-4">
        <div>
          ...
          <span className="text-foreground font-semibold text-sm">${coin.price.toFixed(6)}</span>
        </div>
        <div>
          <span className="text-muted-foreground block mb-0.5">MCap</span>
          <span className="text-foreground font-semibold text-sm">{formatNum(coin.marketCap)}</span>
        </div>
        <div>
          <span className="text-muted-foreground block mb-0.5">Volume</span>
          <span className="text-foreground font-semibold text-sm">{formatNum(coin.volume24h)}</span>
        </div>
      </div>
      <div>
        <div className="flex justify-between text-xs text-muted-foreground mb-1.5">
          <span>Bonding Curve</span>
          <span className="text-foreground font-bold">{coin.bondingProgress}%</span>
        </div>
        <div className="h-2 bg-muted rounded-full overflow-hidden">
          <div 
            ...
            style={{ 
              ...
              boxShadow: coin.bondingProgress > 70 
                ? '0 0 8px hsl(330 85% 60% / 0.5)' 
